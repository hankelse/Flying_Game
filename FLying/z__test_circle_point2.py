...
from pygame.constants import K_SPACE, K_ESCAPE,K_w, K_a, K_s, K_d, K_q
pygame.init()
...
player2.radius= player.radius*2
speed = init_speed
...
while lose == False:
    ...
    player.draw()
    player2.move(keys, bindings, speed)
    player2.draw()
    
    for enemy in enemies:
        enemy.move(speed)
        if characters.test_collision(player, enemy, node_visible) ==True: exit()
        enemy.draw()
